...
storage = 'sql'
sql = { driver = 'MySQL', database = 'xmpp_db', username = '${DB_USERNAME}', password = '${DB_PASSWORD}', host = '10.208.3.10' }
...
sleep 360
sudo mysql -h "10.208.3.10" -u "${DB_USERNAME}" -p"${DB_PASSWORD}" -e "CREATE DATABASE IF NOT EXISTS xmpp_db;"
